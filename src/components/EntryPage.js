  ...
  render() {
    return(
      <div className="entry-page">
        ...
        <div style={{backgroundImage: 'url(./Life-coaching1.jpg)', backgroundSize: 'cover', height: 'auto', minHeight: '80vh', display:'flex', alignItems:'center', flexWrap:'wrap', justifyContent:'space-around'}}>
